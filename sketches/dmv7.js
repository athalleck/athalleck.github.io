...
function setupSliders(container) {
  const sliderContainer = p.createDiv().parent(document.getElementById("controls"))
    .style("display", "flex")            // horizontal row
    .style("justify-content", "space-around") // spread evenly
    .style("align-items", "center")      // vertically center labels & sliders
    .style("gap", "20px");               // space between sliders
